 ...
 * Load hero template.
 *
 * Includes the hero template for a theme or if a name is specified then a
 * specialised footer will be included.
 *
 * @since 1.5.0
 *
...
function get_hero( $name = null ) {
	/**
	 * Fires before the hero template file is loaded.
	 *
	 * @since 2.1.0
	 * @since 2.8.0 $name parameter added.
	 *
	 * @param string|null $name Name of the specific footer file to use. null for the default footer.
	 */
	do_action( 'get_hero', $name );

	$templates = array();
	$name = (string) $name;
	if ( '' !== $name ) {
		$templates[] = "hero-{$name}.php";
	}
 ...
 *
 * Includes the subscribe template for a theme or if a name is specified then a
 * specialised footer will be included.
 *
 * @since 1.5.0
 *
 * @param string $name The name of the specialised footer.
 */
function get_subscribe( $name = null ) {
	/**
	 * Fires before the hero template file is loaded.
	 *
	 * @since 2.1.0
